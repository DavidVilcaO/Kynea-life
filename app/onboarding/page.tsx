...
import { ChevronRight, ChevronLeft, Check, Music2, Upload } from 'lucide-react';
...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-violet-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-xl">
        ...
        <div className="flex items-center gap-2 justify-center mb-8">
          ...
          <span className="text-xl font-black text-gray-900">kynea</span>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          {step === 0 && (
            <div>
              <h2 className="text-xl font-black text-gray-900 mb-2">¿Cómo te describes?</h2>
              <p className="text-sm text-gray-500 mb-6">Elige el tipo de perfil que mejor te representa</p>
              <div className="space-y-3">
                {[
                  ...
                  >
                    ...
                    {form.profileType === opt.value && (
                      <div className="ml-auto w-6 h-6 bg-purple-600 rounded-full flex items-center justify-center">
          ...
          {step === 1 && (
            <div>
              <h2 className="text-xl font-black text-gray-900 mb-2">Tus datos públicos</h2>
              <p className="text-sm text-gray-500 mb-6">Esto es lo que verán los alumnos en tu perfil</p>
              <div className="space-y-4">
                <div className="flex flex-col items-center gap-3 mb-4">
                  <div className="w-20 h-20 rounded-2xl bg-gray-100 flex items-center justify-center cursor-pointer hover:bg-gray-200 transition-colors border-2 border-dashed border-gray-300">
                    <Upload className="w-6 h-6 text-gray-400" />
                  </div>
                  <p className="text-xs text-gray-500">Subir foto o logo</p>
                </div>
                {[
                  ...
                  <div key={field.key}>
                    ...
                    {field.type === 'textarea' ? (
                      ...
                      <input
                        ...
                        value={(form as Record<string, unknown>)[field.key] as string}
                        onChange={e => set(field.key as keyof typeof form, e.target.value)}
                        className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 outline-none focus:border-purple-400"
                      />
                    )}
                  </div>
                ))}
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 outline-none bg-white"
                    >
          ...
          {step === 2 && (
            <div>
              <h2 className="text-xl font-black text-gray-900 mb-2">Contacto y redes</h2>
              <p className="text-sm text-gray-500 mb-6">Los alumnos te contactarán por estos canales</p>
              <div className="space-y-4">
                {[
          ...
          {step === 3 && (
            <div>
              <h2 className="text-xl font-black text-gray-900 mb-2">Tu especialidad</h2>
              <p className="text-sm text-gray-500 mb-4">¿Qué estilos enseñas?</p>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1.5">Años de experiencia</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1.5">Público objetivo</label>
                  <select
                    value={form.audience}
          ...
          {step === 4 && (
            <div>
              <h2 className="text-xl font-black text-gray-900 mb-2">Validación</h2>
              <p className="text-sm text-gray-500 mb-6">Último paso: confirma tus datos</p>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Confirmar correo</p>
                    <p className="text-xs text-gray-500">Te enviamos un código a tu email</p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Confirmar celular</p>
                    <p className="text-xs text-gray-500">Te enviamos un SMS de verificación</p>
                  </div>
                  <button
                ...
                <label className="flex items-start gap-3 cursor-pointer p-4 border border-gray-200 rounded-xl">
                  <input
                    type="checkbox"
                  ...
                  <span className="text-sm text-gray-600">
                    Acepto las <span className="text-purple-600 underline cursor-pointer">reglas de publicación</span> de Kynea y me comprometo a mantener mis clases actualizadas.
                  </span>
                </label>
              </div>
              <div className="mt-6 p-4 bg-purple-50 rounded-xl">
                <p className="text-sm font-semibold text-purple-800 mb-1">🎉 ¡Ya casi!</p>
                <p className="text-xs text-purple-600">Al completar el registro podrás publicar tu primera clase.</p>
              </div>
            </div>
          )}
